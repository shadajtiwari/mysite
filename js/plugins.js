    ...
    n.prototype.options = {
        ...
        for (var s in this.DOM.animatable)
            if (void 0 != this.DOM.animatable[s] && void 0 != this.options.movement[s]) {
                var r = void 0 != this.options.movement[s] ? this.options.movement[s].translation || {
                        x: 0,
                        y: 0,
                        z: 0
                    } : {
                    ...
                    l = void 0 != this.options.movement[s] ? this.options.movement[s].rotation || {
                        x: 0,
                        y: 0,
                        z: 0
                    } : {
                ...
                var c = {
                    translation: {
                        x: (r.x[1] - r.x[0]) / o.width * a.x + r.x[0],
                        y: (r.y[1] - r.y[0]) / o.height * a.y + r.y[0],
                        z: (r.z[1] - r.z[0]) / o.height * a.y + r.z[0]
                    },
                    rotation: {
                        x: (l.x[1] - l.x[0]) / o.height * a.y + l.x[0],
                        y: (l.y[1] - l.y[0]) / o.width * a.x + l.y[0],
                        z: (l.z[1] - l.z[0]) / o.width * a.x + l.z[0]
                    }
                };
                this.DOM.animatable[s].style.WebkitTransform = this.DOM.animatable[s].style.transform = "translateX(" + c.translation.x + "px) translateY(" + c.translation.y + "px) translateZ(" + c.translation.z + "px) rotateX(" + c.rotation.x + "deg) rotateY(" + c.rotation.y + "deg) rotateZ(" + c.rotation.z + "deg)"
            }
    }, t.TiltFx = n
}(window);
